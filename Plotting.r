...
ggmap(map) + geom_point(aes(x=X,y=Y,color=Category),size = 0.5, alpha = 0.5,data=dfFiltered) + geom_point(size=3,alpha=0.3)+
labs(title = "Crime plot for Drinking Crimes in San Francisco")+
